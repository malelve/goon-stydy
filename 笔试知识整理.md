...
<img src="http://www.justdojava.com/assets/images/2019/java/image-jay/c25904af60394296a36c41d0c3749ab4.jpg" alt="img" style="zoom: 25%;" />

<img src="http://www.justdojava.com/assets/images/2019/java/image-jay/4c0ea9d4d39c4ab09ed7e81ac76993d1.jpg" alt="img" style="zoom:25%;" />

Collection ------>List、Queue、Set

​	List ------> ArrayList、LinkList

​	Queue -------> PriorityQue、ArrayQue(Deque)

​	Set -------> HashSet、LinkedHashSet、TreeSet(SortedSet)

Map -------> AbstractMap、SortedMap、Hashtable
...
- [ ] 40.服务器端出现close_wait过多，是什么原因？（**结合32**）
- [x] 41.什么是短链接，什么是长连接
