...
- [x] 18.高并发场景下，如何保证程序数据保存到redis的线程安全问题？（**redis是单线程的，非常安全，redis6之后是多线程的，但是事务提交还是由一个线程执行，很安全**）
...
- [ ] 83.https如何实现密钥交互，数字认证，已经数字认证流程？
